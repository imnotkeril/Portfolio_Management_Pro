    ...
    def analyze_return_sensitivity(
        ...
        for var in variations:
            ...
            try:
                ...
                logger.warning(f"Sensitivity analysis failed for variation {var}: {e}")
            finally:
    ...
    def analyze_constraint_sensitivity(
        ...
        for val in constraint_values:
            ...
            try:
                ...
                logger.warning(
                    f"Sensitivity analysis failed for {constraint_name}=" f"{val}: {e}"
                )
    ...
    def analyze_parameter_sensitivity(
        ...
        for val in parameter_values:
            try:
                ...
                logger.warning(
                    f"Sensitivity analysis failed for {parameter_name}=" f"{val}: {e}"
                )
